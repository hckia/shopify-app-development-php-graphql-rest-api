...
class Shopify {
    ...
    // rest api needs the endpoint, method, and query
    ...
    public function rest_api($api_endpoint, $query = array(), $method = 'GET') {
        ...
        if(in_array($method, array('GET', 'DELETE')) && !is_null($query)) {
            //http_build_query parses the array into a query string
        ...
        curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, false); // check SSL
